        ...
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <form action="#" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input id="nama" name="nama" rows="3" class="block w-full rounded-lg border-gray-300 bg-gray-50 py-3 px-4 text-gray-900 focus:border-green-500 focus:ring-green-500" placeholder="Nama"></input>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="jumlah" name="jumlah" placeholder="0" class="block w-full rounded-lg border-gray-300 bg-gray-50 py-3 pl-12 pr-4 text-gray-900 text-lg font-semibold focus:border-green-500 focus:ring-green-500" inputmode="numeric">
                    </div>
                </div>
