            ...
            <div class="mt-8 bg-white rounded-2xl shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="font-bold text-blue-600 text-right ml-2">
                            Rp{{ number_format(($totalCashFlow ?? 0) * 0.50, 0, ',', '.') }}
                        </p>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="font-bold text-purple-600 text-right ml-2">
                            Rp{{ number_format(($totalCashFlow ?? 0) * 0.30, 0, ',', '.') }}
                        </p>
                    </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="font-bold text-green-600 text-right ml-2">
                            Rp{{ number_format(($totalCashFlow ?? 0) * 0.20, 0, ',', '.') }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:w-1/3 mt-8 lg:mt-0">
            ...
            <div class="mb-8 bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div class="grid grid-cols-3 gap-4 text-center">
                    ...
                    <a href="{{ route('tambah-pengeluaran') }}"
                        class="flex flex-col items-center space-y-2 hover:bg-gray-100 p-2 rounded-lg transition-colors duration-200">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div class="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center mr-4 flex-shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" class="text-red-500" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
